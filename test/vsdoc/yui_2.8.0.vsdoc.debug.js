...
var LogReader = function(elContainer, oConfigs) {
...
var LogWriter = function(sSource) {
...
//Starting Methods
Connect.createFrame = function(optional) {
...
Connect.setForm = function(form, optional) {
...
Connect.uploadFile = function(id, callback, uri, postData) {
...
Connect.handleXdrResponse = function(The) {
...
Connect.appendPostData = function(postData) {
...
Connect.transport = function(URI) {
...
Connect.xdr = function(The, HTTP, URI) {
...
EventProvider.prototype.unsubscribeAll = function(p_type) {
...
EventProvider.prototype.subscribe = function(p_type, p_fn, p_obj, overrideContext) {
...
EventProvider.prototype.unsubscribe = function(p_type, p_fn, p_obj) {
...
EventProvider.prototype.hasEvent = function(type) {
...
EventProvider.prototype.fireEvent = function(p_type, arguments) {
...
EventProvider.prototype.createEvent = function(p_type, p_config) {
...
LogReader.prototype.getLastTime = function() {
   /// <summary> Gets timestamp of the last log. </summary>
   /// <returns type="Date" />
};
LogReader.prototype._onReset = function(sType, aArgs, oSelf) {
...
LogReader.prototype.getCategories = function() {
   /// <summary> Returns array of enabled categories. </summary>
   /// <returns type="String[]" />
};
LogReader.prototype._createSourceCheckbox = function(sSource) {
...
LogReader.prototype.hide = function() {
   /// <summary> Hides UI of LogReader. Logging functionality is not disrupted. </summary>
};
LogReader.prototype._printToConsole = function(aEntries) {
...
LogReader.prototype._onClickClearBtn = function(v, oSelf) {
   /// <summary> Handles click events on the clear button. </summary>
   /// <private />
 /// <param name="v" type="HTMLEvent">  The click event.</param>
 /// <param name="oSelf" type="Object">  The LogReader instance.</param>
};
LogReader.prototype.resume = function() {
...
LogReader.prototype._onSourceCreate = function(sType, aArgs, oSelf) {
...
LogReader.prototype._onClickPauseBtn = function(v, oSelf) {
   /// <summary> Handles click events on the pause button. </summary>
   /// <private />
 /// <param name="v" type="HTMLEvent">  The click event.</param>
 /// <param name="oSelf" type="Object">  The LogReader instance.</param>
};
LogReader.prototype._initFooterEl = function() {
   /// <summary> Initializes the footer element. </summary>
   /// <private />
};
LogReader.prototype._onNewLog = function(sType, aArgs, oSelf) {
...
LogReader.prototype._initConsoleEl = function() {
   /// <summary> Initializes the console element. </summary>
   /// <private />
};
LogReader.prototype._initContainerEl = function() {
   /// <summary> Initializes the primary container element. </summary>
   /// <private />
};
LogReader.prototype.clearConsole = function() {
...
LogReader.prototype.hideSource = function(Source) {
   /// <summary> Hides log messages associated with given source. </summary>
 /// <param name="Source" type="String"> name.</param>
};
LogReader.prototype.getCheckbox = function(Category) {
...
YAHOO.tool.TestSuite.XML = function(result) {
...
YAHOO.tool.TestSuite.JSON = function(result) {
...
YAHOO.util.Dom.IEStyle.getOffset = function(el, prop) {
   /// <summary> Determine the offset of an element </summary>
   /// <returns type="String" />
 /// <param name="el" type="HTMLElement"> The element to check</param>
 /// <param name="prop" type="String"> The property to check.</param>
};
...
YAHOO.util.Event.addBlurListener = function(el, fn, obj, overrideContext) {
   /// <summary> Attaches a focusout event listener to the specified element for the purpose of listening for the blur event on the element's descendants. </summary>
   /// <returns type="Boolean" />
...
YAHOO.util.Event.removeBlurListener = function(el, fn) {
   /// <summary> Removes a focusout event listener to the specified element for the purpose of listening for the blur event on the element's descendants. </summary>
   /// <returns type="boolean" />
...
YAHOO.util.Event.addFocusListener = function(el, fn, obj, overrideContext) {
   /// <summary> Attaches a focusin event listener to the specified element for the purpose of listening for the focus event on the element's descendants. </summary>
   /// <returns type="Boolean" />
 /// <param name="el" type="String|HTMLElement|Array|NodeList"> An id, an element reference, or a collection of ids and/or elements to assign the listener to.</param>
 /// <param name="fn" type="Function">        The method the event invokes</param>
 /// <param name="obj" type="Object">    An arbitrary object that will be passed as a parameter to the handler</param>
...
YAHOO.util.Event.removeFocusListener = function(el, fn) {
   /// <summary> Removes a focusin event listener to the specified element for the purpose of listening for the focus event on the element's descendants. </summary>
   /// <returns type="boolean" />
 /// <param name="el" type="String|HTMLElement|Array|NodeList"> An id, an element reference, or a collection of ids and/or elements to removethe listener from.</param>
 /// <param name="fn" type="Function"> the method the event invokes.  If fn isundefined, then all event handlers for the type of event are removed.</param>
};
...
YAHOO.util.SWFStore.prototype.setItem = function(data, location) {
   /// <summary> Saves data to local storage. It returns a String that canbe one of three values: "true" if the storage succeeded; "false" if the userhas denied storage on their machine or storage space allotted is not sufficient.The size limit for the passed parameters is ~40Kb. </summary>
   /// <returns type="Boolean" />
...
YAHOO.widget.Carousel.prototype._getLastVisible = function() {
   /// <summary> Get the index of the last visible item </summary>
};
...
YAHOO.widget.Record.prototype.setData = function(sKey, oData) {
   /// <summary> Sets given data at the given key. Use the RecordSet method updateRecordValue to triggerevents. </summary>
...
YAHOO.widget.Uploader.prototype.uploadThese = function(fileIDs, uploadScriptPath, method, vars, fieldName) {
   /// <summary> Starts the upload of the files specified by fileIDs, or adds them to a currently running queue. The upload queue is automatically managed. </summary>
 /// <param name="fileIDs" type="Array">  The ids of the files to start uploading.</param>
 /// <param name="uploadScriptPath" type="String">  The URL of the upload location.</param>
 /// <param name="method" type="String">  Either "GET" or "POST", specifying how the variables accompanying the file upload POST request should be submitted. "GET" by default.</param>
 /// <param name="vars" type="Object">  The object containing variables to be sent in the same request as the file upload.</param>
 /// <param name="fieldName" type="String">  The name of the variable in the POST request containing the file data. "Filedata" by default.</param>
